...
public class AESHelper {
    ...
    public static String encryptCBC(String data, String sec_key, String ivStr) {
        IvParameterSpec iv = new IvParameterSpec(ivStr.getBytes());
        SecretKeySpec key = new SecretKeySpec(sec_key.getBytes(), "AES");
        try {
            return encrypt("AES/CBC/PKCS7Padding", data, key, iv);
